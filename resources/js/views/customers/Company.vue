        ...
        <div class="col-lg-12">
            <portlet @onPortlet="onPortlet" id="m_portlet_tools_modules" :title="lang.choice('pages.company.title', 2)">
                <template slot="actions">
                    <action-item v-if="selected.length === 1 && $auth.can('edit-companies')">
                        <a href="javascript:;"
                    ...
                    <action-item v-if="selected.length > 0 && $auth.can('delete-companies')" >
                        <a href="javascript:;"
                    ...
                    <portlet-dropdown-actions>
                        ...
                        <template slot="items">
                            <li  v-if="$auth.can('create-companies')" class="m-nav__item">
                            ...
                            <li v-if="selected.length === 1 && $auth.can('edit-companies')" class="m-nav__item">
                            ...
                            <li v-if="selected.length > 0 && $auth.can('delete-companies')"  @click.prevent="onDelete" class="m-nav__item">
                                <a href="#" class="m-nav__link">
