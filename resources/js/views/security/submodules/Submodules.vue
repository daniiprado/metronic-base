        ...
        <div class="col-lg-12">
            <portlet @onPortlet="onPortlet" id="m_portlet_tools_modules" :title="lang.choice('pages.submodules.title', 2)">
                <template slot="actions">
                    <action-item v-if="selected.length === 1 && $auth.can('edit-submodule')">
                        <a href="javascript:;"
                    ...
                    <action-item v-if="selected.length > 0 && $auth.can('delete-submodule')" >
                        <a href="javascript:;"
                    ...
                    <portlet-dropdown-actions>
                        ...
                        <template slot="items">
                            <li v-if="$auth.can('create-submodule')" class="m-nav__item">
                            ...
                            <li v-if="selected.length === 1 && $auth.can('edit-submodule')" class="m-nav__item">
                            ...
                            <li v-if="selected.length > 0 && $auth.can('delete-submodule')"  @click.prevent="onDelete" class="m-nav__item">
                                <a href="#" class="m-nav__link">
