        ...
        <div class="col-lg-12">
            <portlet @onPortlet="onPortlet" id="m_portlet_tools_modules" :title="lang.choice('pages.company.title', 2)">
                <template slot="actions">
                    ...
                    <action-item v-if="selected.length > 0 && $auth.can('delete-business-unities')" >
                        <a href="javascript:;"
                    ...
                    <portlet-dropdown-actions>
                        ...
                        <template slot="items">
                            <li v-if="$auth.can('create-business-unities')" class="m-nav__item">
                                <router-link class="m-nav__link" :to="{ name: 'business.unity.create' }">
                                    <i class="m-nav__link-icon la la-plus-circle"></i>
                                    <span class="m-nav__link-text" v-text="lang.get('pages.buttons.add')">Create</span>
                                </router-link>
                            </li>
                            <li v-if="selected.length === 1  && $auth.can('edit-business-unities')" class="m-nav__item">
                            ...
                            <li v-if="selected.length > 0 && $auth.can('delete-business-unities')"  @click.prevent="onDelete" class="m-nav__item">
                                <a href="#" class="m-nav__link">
    ...
    export default {
        ...
        data: () => {
            return {
                ...
                options: {
                    ajax: {
                        url: API.END_POINTS.CUSTOMERS.UNITY.DATATABLE,
                    },
                    columns: [
                        {
                            data: 'id',
