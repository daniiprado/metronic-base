                                ...
                                <div class="m-messenger__message m-messenger__message--in">
                                    ...
                                    <div class="m-messenger__message-body">
                                        ...
                                        <div class="m-messenger__message-content">
                                            ...
                                            <div class="m-messenger__message-text"> Hi Bob. What time will be the meeting
                                                ?
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="m-list-settings m-scrollable">
                        <div class="m-list-settings__group">
                            ...
                            <div class="m-list-settings__item"><span
                                ...
                                name="">							<span></span> 							</label>							</span>	 							</span>
                            </div>
                            <div class="m-list-settings__item"><span
                        ...
                        <div class="m-list-timeline__group">
                            ...
                            <div class="m-list-timeline__items">
                                ...
                                <div class="m-list-timeline__item"><span
                                    ...
                                    server down <span class="m-badge m-badge--danger m-badge--wide">pending</span></a>
                                    <span class="m-list-timeline__time">3 hrs</span></div>
                                <div class="m-list-timeline__item"><span
                                    class="m-list-timeline__badge m-list-timeline__badge--state-success"></span> <a
                        ...
                        <div class="m-list-timeline__group">
                            ...
                            <div class="m-list-timeline__items">
                                <div class="m-list-timeline__item"><span
                                    ...
                                    order received <span class="m-badge m-badge--info m-badge--wide">urgent</span></a>
...
<script>
    ...
    export default {
        ...
        data: () => {
            return {
                user: {
                    username: 'Destino Seguro',
                    email: 'root@destinoseguro.net',
                }
            }
        },
    }
