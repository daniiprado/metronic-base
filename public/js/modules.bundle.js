...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_sweetalert2__ = __webpack_require__(127);
            ...
            __WEBPACK_IMPORTED_MODULE_0_sweetalert2___default()({
                ...
                preConfirm: function preConfirm() {
                    that.selected.map(function (item) {
                        that.form.delete('/api/module/' + item.id).then(function (response) {
                            that.datatable.ajax.reload(false);
    ...
    methods: {
        ...
        onSubmit: function onSubmit() {
            ...
            this.$validator.validateAll().then(function (result) {
                if (result) {
                    mApp.blockPage();
                    _this.form.post('/api/module').then(function (response) {
                        mApp.unblockPage();
                        __WEBPACK_IMPORTED_MODULE_0_sweetalert2___default()({
                            type: 'success',
                            title: _this.lang.get('pages.messages.success'),
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        onSubmit: function onSubmit() {
            ...
            this.$validator.validateAll().then(function (result) {
                if (result) {
                    mApp.blockPage();
                    _this.form.put('/api/module/' + _this.$route.params.id).then(function (response) {
                        mApp.unblockPage();
                        __WEBPACK_IMPORTED_MODULE_0_sweetalert2___default()({
                            type: 'success',
                            title: _this.lang.get('pages.messages.success'),
    ...
    beforeRouteEnter: function beforeRouteEnter(to, from, next) {
        axios.get('/api/module/' + to.params.id).then(function (response) {
